...
def main():
    ...
    #
    # ТОЛЬКО АНАЛИЗ. В пайплайн не входит: ни генерация, ни симуляторы, ни
    # конфиг о нём не знают, умолчание 0.0, из конфига НЕ читается. Сдвинутое
    # число — ответ на диагностический вопрос, а не оценка детали.
