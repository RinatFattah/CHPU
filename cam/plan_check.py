...
# Формула `t` и `B` одна на систему и живёт в plan.py: она про поля плана, а не
# про нормативы. Здесь их только сравнивают с пределом.
from cam.plan import tb_of, EXACT, UPPER  # noqa: E402,F401
